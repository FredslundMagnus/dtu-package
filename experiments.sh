...
bsub -o "outputs/Example2/Markdown/Example2_0.md" -J "Example2_0" -env MYARGS="-name Example2-0 -time 3600 -b 4.0 -a 1 -d dssf -k main~Param~('sdf@sdf'#.#)~#.'s':@78.# -ID 0" < submit_v16.sh
